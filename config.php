<?php
	...
	define('DB_USER', "Uyhiblog");
	define('DB_NAME', "Nyhiblog");
	define('DB_PASS', "Pyhiblog");
	define('DB_PORT', '5432'); // usually 3306 for MySQL
	...
	define('SELF_URL_PATH', 'https://shui.azurewebsites.net/');
